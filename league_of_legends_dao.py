...
class OracleConnection:
    ...
    def league_of_legends_champions_merge(self, language, champion):
        sql = sqlalchemy.text(self.league_of_legends_sql_json["LEAGUE_OF_LEGENDS_CHAMPIONS"]["MERGE"])
    ...
    def league_of_legends_champions_merge_list(self, language, champions):
        return sum(self.league_of_legends_champions_merge(language, champion) for champion in champions)
